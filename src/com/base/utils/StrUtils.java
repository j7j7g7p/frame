...
public class StrUtils {
	...
	public static String getSubStr(String str, String begin, String end) {
		int beginIndex = str.indexOf(begin);
		int endIndex = str.indexOf(end, beginIndex);
		if (beginIndex >= 0 && endIndex >= 0 && endIndex > beginIndex)
			return str.substring(beginIndex + begin.length(), endIndex);
		return null;
	}

	public static String getSubStr(String str, String begin) {
		int beginIndex = str.indexOf(begin);
	...
	public static boolean equals(String s1, String s2, boolean ignoreCase,
			boolean autoTrim, boolean nullEqual) {
		if (s1 == null && s2 == null)
			return nullEqual;
	...
	public static void main(String[] args) {
		String s = "111{0}222{1}333{0}444{2}555{1}666{3}";
		System.out.println(s);
		System.out.println(StrUtils.format(s, new Object[] { "aaa", "bbb",
				"ccc", "ddd", "eee" }));
	}
}